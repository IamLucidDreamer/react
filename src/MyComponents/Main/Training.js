            ...
            <div>
                ...
                <div className="flex flex-wrap my-12">
                    <div className=" md:w-1/2 lg:w-2/3 flex flex-col items-start">
                        ...
                        <h2 className="sm:text-3xl text-2xl title-font font-medium text-gray-900 mt-4 mb-4">Road to Success</h2>
                        <p className="leading-relaxed mb-8">Argus Institute‘s Basic Security Training Course gives you everything you need to
                        ...
                        <p className="leading-relaxed mb-8">You can also take advantage of our Online Learning Platform that features SelfPaced Online Courses (SPOC), optional live instructor-led sessions within our
                            Virtual Training Room (VTR), and 8 hours of in-classroom First Aid/CPR Level C
                            certification training.</p>
                        
                        <h2 className="sm:text-3xl text-2xl title-font font-medium text-gray-900 mt-4 mb-4">Basic Security Traning Course (online) $149.99</h2>
                        <p className="leading-relaxed mb-8">You can take advantage of our Online Learning Platform that features Self-Paced
                            ...
                            certification training.</p>
                        <button className="w-1/3 p-5 rounded-lg text-xl border text-white bg-red-700 hover:bg-white hover:text-red-700 hover:border-red-700">REGISTER</button>

                        <h2 className="sm:text-3xl text-2xl title-font font-medium text-gray-900 mt-4 mb-4">Basic Security Training Course – (In-class room) $199.99</h2>
                            <ul class="mb-8"> 
                                <li><span className="text-red-700">✓</span> Course is five days (40 hours) Monday – Friday, 8:30am – 5:00pm</li>
                                <li><span className="text-red-700">✓</span> Comprehensive Security Manual is included </li>
                                <li><span className="text-red-700">✓</span> Exceeds Ontario government standards</li>
                                <li><span className="text-red-700">✓</span> Our guarantee – if you fail the ministry test, you can retake the course for free!</li>
                                <li><span className="text-red-700">✓</span> Courses run weekly in Brampton. </li>
                            </ul>
                        <button className="w-1/3 p-5 rounded-lg text-xl border text-white bg-red-700 hover:bg-white hover:text-red-700 hover:border-red-700">REGISTER</button>
                        
                        <h2 className="sm:text-3xl text-2xl title-font font-medium text-gray-900 mt-4 mb-4">Basic Security Training Course topics</h2>
                            <ul className="flex">
                                <div className="mx-5">
                                <li><span className="text-red-700">✓</span> Introduction to the Security Industry</li>
                                <li><span className="text-red-700">✓</span> Basic Procedures  </li>
                                <li><span className="text-red-700">✓</span> Regulations </li>
                                <li><span className="text-red-700">✓</span> Use of Force Theory</li>
                                <li><span className="text-red-700">✓</span> Emergencies </li>
                                </div>
                                <div className="mx-5">
                                <li><span className="text-red-700">✓</span> Health & Safety</li>
                                <li><span className="text-red-700">✓</span> Canadian Legal System & Authorities  </li>
                                <li><span className="text-red-700">✓</span> Communication I & II  </li>
                                <li><span className="text-red-700">✓</span> Conflict Resolution</li>
                                <li><span className="text-red-700">✓</span> Diversity & Sensitivity</li>
                                </div>
                            </ul>
                            <h2 className="sm:text-3xl text-2xl title-font font-medium text-gray-900 mt-4 mb-4">FAQ</h2>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">1.</span> Where do I take the test?</p>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">2.</span> Is there a government website to answer my questions?</p>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">3.</span> How much does it cost? </p>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">4.</span> Does this fee include the cost of my license?</p>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">5.</span> Where do I take the training?</p>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">6.</span> Is everything included in the price of the course? </p>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">7.</span> What is the cost to the five days of training?</p>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">8.</span> Do I have to take the test each time my license is going to expire?</p>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">9.</span> How many questions are on the test?</p>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">10.</span> How much time is given to complete the test?</p>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">11.</span> When will I get back my test results? </p>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">12.</span> When is the expiry date on my license? What is the cost of the license? </p>
                            <p className="p-4 mb-2 border-2 border-gray-200 w-full"><span className="text-red-700">13.</span> Do I need to attend the CPR training if I already have the certification?</p>
                        <div>
