...
<div class="w-full fixed">
  ...
  <div class="hidden xl:block container bg-opacity-0 -mb-8 mx-auto flex flex-wrap flex-col md:flex-row items-center ">
...
{/* <div class="relative w-full h-32 block xl:hidden"></div> */}
</div>
    )
  }
}
